...
const Checkbox: React.FC<CheckboxProps> = ({
  ...
  return (
    <div className={cn("flex items-center gap-2", children && "items-start")}>
      <span
        className="relative flex h-4 w-4 cursor-pointer items-center"
      ...
      >
        ...
        <div
          className={`flex h-4 w-4 items-center justify-center rounded-sm border-2 ${
            checked ? "border-GB bg-GB" : "border-gray-500 bg-white"
          }`}
        >
