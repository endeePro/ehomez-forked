...
export interface IBillingSalesFormData {
  billType: string;
  price: string;
}

interface ChildFormProps {
  onSubmit: SubmitHandler<IBillingSalesFormData>;
  initialData: IBillingSalesFormData;
}
...
export const BillingSalesForm = forwardRef<HTMLButtonElement, ChildFormProps>(
...
BillingSalesForm.displayName = "BillingSales";
