...
export interface IBillingShortletFormData {
  billType: string;
  price: string;
...
interface ChildFormProps {
  onSubmit: SubmitHandler<IBillingShortletFormData>;
  initialData: IBillingShortletFormData;
}

const validationSchema = Yup.object().shape({
  billType: Yup.string().required("Billing type is required"),
  price: Yup.string().required("Rental price is required"),
  securityDeposit: Yup.string().optional(),
  serviceCharge: Yup.string().optional(),
  cleaningFee: Yup.string().optional(),
});

export const BillingFormShortlet = forwardRef<
  HTMLButtonElement,
  ChildFormProps
>(({ onSubmit, initialData }, ref) => {
  const {
    ...
    register,
    formState: { errors },
  } = useForm<IBillingShortletFormData>({
        ...
        <div className="flex w-full max-w-[512px] flex-1 flex-col gap-4 lg:mx-auto">
          <div className="flex w-full flex-col gap-1">
            ...
            <SMSelectDropDown
              ...
              name="billingType"
              value={
                billType.filter((value) => value.value === watch("billType"))[0]
              }
              onChange={(value) => {
      ...
      <fieldset className="flex w-full border-b border-solid border-[#EAECF0] pb-6 mmd:flex-col mmd:gap-2">
        ...
        <div className="flex w-full max-w-[512px] flex-1 flex-col gap-4 lg:mx-auto">
          <TextField
            ...
            inputType="input"
            type="number"
            placeholder="Enter Security Deposit Percentage"
            register={register}
            error={!!errors.securityDeposit}
            errorText={errors.securityDeposit?.message}
          />
        </div>
      </fieldset>
      <fieldset className="flex w-full border-b border-solid border-[#EAECF0] pb-6 mmd:flex-col mmd:gap-2">
        ...
        <div className="flex w-full max-w-[512px] flex-1 flex-col gap-4 lg:mx-auto">
          <TextField
            ...
            errorText={errors.serviceCharge?.message}
          />
        </div>
      </fieldset>
      <fieldset className="flex w-full border-b border-solid border-[#EAECF0] pb-6 mmd:flex-col mmd:gap-2">
        ...
        <div className="flex w-full max-w-[512px] flex-1 flex-col gap-4 lg:mx-auto">
          <TextField
            ...
            errorText={errors.cleaningFee?.message}
          />
        </div>
      </fieldset>
...
BillingFormShortlet.displayName = "BillingFormShortlet";
